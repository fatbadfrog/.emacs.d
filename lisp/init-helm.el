...
;; C-c h r: helm-regexp <f2> Query Replace Regexp
;; C-x r s REG: copy region to register REG
;; C-x r i REG: insert text from register REG
;; C-c h t: invoke top in which processes can be inacted
;; C-c h s: surfacew


(helm-mode 1)

;; configuration of swoop
(require 'helm-swoop)
...
(define-key isearch-mode-map (kbd "C-c h w") 'helm-swoop-from-isearch)
;; From helm-swoop to helm-multi-swoop-all
(define-key helm-swoop-map (kbd "C-c h m") 'helm-multi-swoop-all-from-helm-swoop)
